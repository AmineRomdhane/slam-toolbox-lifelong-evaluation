...
WS=Path(__file__).resolve().parents[3];REF=WS/'reference_maps/static/world_v0/r1';ROOT=WS/'results/static/world_v0/r1'
...
def main(output):
 ...
 # Verify the relocated sources against their layout manifest; historical hashes remain archived.
 import sys
 sys.path.insert(0,str(WS/'benchmark/tools'))
 from layout import verify_tool_sources
 verify_tool_sources(WS)
