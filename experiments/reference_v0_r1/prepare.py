...
WS=Path('/home/roam5170/slam_testing'); TB=Path('/home/roam5170/turtlebot3_ws/src/turtlebot3_simulations/turtlebot3_gazebo')
...
def prepare(out):
 ...
 inspection=json.loads((WS/'reference_maps/static/world_v0/r1/input_inspection.json').read_text())
 ...
 world=ET.parse(TB/'worlds/turtlebot3_world.world');w=world.find('world');fuel=Path('/home/roam5170/.gz/fuel/fuel.gazebosim.org/openrobotics/models')
